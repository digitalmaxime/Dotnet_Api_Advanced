...
public class CreatePlaneCommandHandler : IRequestHandler<CreatePlaneCommand, VehicleSnapshotEntityBase?>
{
    ...
    public async Task<VehicleSnapshotEntityBase?> Handle(CreatePlaneCommand request, CancellationToken cancellationToken)
    {
