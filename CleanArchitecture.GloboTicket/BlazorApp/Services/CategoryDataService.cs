...
namespace GloboTicket.TicketManagement.App.Services
{
    public class CategoryDataService : BaseDataService, ICategoryDataService
    {
        ...
        public CategoryDataService(IMyClient client, IMapper mapper, ILocalStorageService localStorage): base(client, localStorage)
        {
            _mapper = mapper;
        }
        ...
        {
            var allCategories = await _client.GetAllCategoriesWithEventsAsync(includeHistory);
